...
const BreadCrumbBanner = ({title}) => {
  return (
      <div className='py-10 md:py-20 lg:py-24 '>
          <h1 className='font-nunito font-bold text-[30px]  mb-3 md:text-[40px] lg:text-5xl'>{window.location.pathname.split("/")[1].charAt(0).toUpperCase() + window.location.pathname.split("/")[1].slice(1)}</h1>
          {/* bread crumb */}
